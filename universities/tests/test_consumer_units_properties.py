...
class TestConsumerUnitsProperties:
    ...
    def test_reads_consumer_unit_properties_no_energy_bill_filled(self):
        ...
        assert geted_consumer_unit['date'] == self.contract_1.start_date
        assert geted_consumer_unit['is_current_energy_bill_filled'] == False
        assert geted_consumer_unit['pending_energy_bills_number'] == 10
