...
class TestContractEndpoint:
    def setup_method(self):
        ...
        self.contract_test_1_dict = dicts_utils.contract_dict_1
        self.contract_test_2_dict = dicts_utils.contract_dict_2
        self.contract_test_3_dict = dicts_utils.contract_dict_3
        self.contract_test_4_dict = dicts_utils.contract_dict_4

        self.contract_test_1 = create_objects_utils.create_test_contract(self.contract_test_1_dict, self.distributor, self.consumer_unit_test)
        self.contract_test_2 = create_objects_utils.create_test_contract(self.contract_test_2_dict, self.distributor, self.consumer_unit_test)
        self.contract_test_3 = create_objects_utils.create_test_contract(self.contract_test_3_dict, self.distributor, self.consumer_unit_test)
        self.contract_test_4 = create_objects_utils.create_test_contract(self.contract_test_4_dict, self.distributor, self.consumer_unit_test)
    ...
    def test_throws_exception_create_contract_with_start_date_not_valid(self):
        with pytest.raises(Exception) as e:
            contract_test_6_dict = dicts_utils.contract_dict_6
            create_objects_utils.create_test_contract(contract_test_6_dict, self.distributor, self.consumer_unit_test)
